...
public class Tests {
    ...
    public static void drawThreeSquares(RGBmatrixPanelNoObjects rgbMatrixPanel) {
        // A square
        ...
        rgbMatrixPanel.drawPixel(24, 23, Color.RED);
        rgbMatrixPanel.drawPixel(25, 23, Color.RED);
        rgbMatrixPanel.drawPixel(26, 23, Color.RED);
        rgbMatrixPanel.drawPixel(27, 23, Color.RED);
        rgbMatrixPanel.drawPixel(28, 23, Color.RED);
        rgbMatrixPanel.drawPixel(29, 23, Color.RED);

        rgbMatrixPanel.drawPixel(23, 23, Color.RED);
        rgbMatrixPanel.drawPixel(23, 24, Color.RED);
        rgbMatrixPanel.drawPixel(23, 25, Color.RED);
        rgbMatrixPanel.drawPixel(23, 26, Color.RED);
        rgbMatrixPanel.drawPixel(23, 27, Color.RED);
        rgbMatrixPanel.drawPixel(23, 28, Color.RED);
        rgbMatrixPanel.drawPixel(23, 29, Color.RED);

        rgbMatrixPanel.drawPixel(29, 23, Color.RED);
        rgbMatrixPanel.drawPixel(29, 24, Color.RED);
        rgbMatrixPanel.drawPixel(29, 25, Color.RED);
        rgbMatrixPanel.drawPixel(29, 26, Color.RED);
        rgbMatrixPanel.drawPixel(29, 27, Color.RED);
        rgbMatrixPanel.drawPixel(29, 28, Color.RED);
        rgbMatrixPanel.drawPixel(29, 29, Color.RED);

        rgbMatrixPanel.drawPixel(23, 29, Color.RED);
        rgbMatrixPanel.drawPixel(24, 29, Color.RED);
        rgbMatrixPanel.drawPixel(25, 29, Color.RED);
        rgbMatrixPanel.drawPixel(26, 29, Color.RED);
        rgbMatrixPanel.drawPixel(27, 29, Color.RED);
        rgbMatrixPanel.drawPixel(28, 29, Color.RED);
        rgbMatrixPanel.drawPixel(29, 29, Color.RED);
    }
