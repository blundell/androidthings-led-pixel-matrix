 ...
 */
public class AndroidThingsGpioProxy implements GpioProxy {
    ...
    public AndroidThingsGpioProxy() {
        ...
        try {
            ...
            busLedG1 = service.openGpio("BCM20");
            busLedB1 = service.openGpio("BCM16");
...
//         TODO
    ...
    public void writePixelsSequence(byte pins) {
        try {
            busLedR1.setValue((pins & 0b100) == 0b100);
            busLedG1.setValue((pins & 0b10) == 0b10);
            busLedB1.setValue((pins & 0b1) == 0b1);

            busLedR2.setValue((pins & 0b100_000) == 0b100_000);
            busLedG2.setValue((pins & 0b10_000) == 0b10_000);
            busLedB2.setValue((pins & 0b1_000) == 0b1_000);
        } catch (IOException e) {
            throw new IllegalStateException(e);
        }
    }
